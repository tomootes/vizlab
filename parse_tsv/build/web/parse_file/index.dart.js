...
["", "index.dart", , E, {
  "^": "",
  main: [function() {
    var t1, result, t2, onError;
    $.get$stopwatch().start$0(0);
    document.querySelector("body").textContent = "Loading data/angry.tsv";
    t1 = W.HttpRequest_getString("data/angry.tsv", null, null).then$1(E.processingString$closure());
    result = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
    t2 = result._zone;
    if (t2 !== C.C__RootZone)
      onError = P._registerErrorHandler(E.handleError$closure(), t2);
    else
      onError = E.handleError$closure();
    t1._addListener$1(new P._FutureListener(null, result, 2, null, onError));
  }, "call$0", "main$closure", 0, 0, 2],
  processingString: [function(s) {
    var coordinates, t1;
    document.querySelector("body").textContent = "Processing string to list";
    coordinates = E.stringToArray(s, 10);
    if (0 >= coordinates.length)
      return H.ioore(coordinates, 0);
    t1 = coordinates[0];
    document.querySelector("body").textContent = t1;
  }, "call$1", "processingString$closure", 2, 0, 7],
  stringToArray: function(s, firstRow) {
    var coordinates, t1, lineIndex, charIndex, i, t2;
    coordinates = [];
    ...
    while (true) {
      ...
      if (J.$eq(t1.$index(s, i), "\n")) {
        ...
        if (lineIndex >= firstRow)
          coordinates.push(t1.substring$2(s, charIndex, i));
        charIndex = i;
      }
      ++i;
    }
  ...
  }, "call$1", "handleError$closure", 2, 0, 8]
},
1],
]);
...
Isolate.$lazy($, "stopwatch", "stopwatch", "get$stopwatch", function() {
